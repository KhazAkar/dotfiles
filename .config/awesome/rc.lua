...
run_once("/usr/lib/polkit-gnome-authentication-agent-1")
...
-- XRandR
run_once("xrandr --output eDP1 --primary --output DP1-1 --right-of eDP1")

-- Compton
run_once("compton -b -d :0 --backend glx --vsync opengl-swc")
...
awful.util.tagnames = { "Main", "Second", "Third", "Fourth", "Fifth" }
